...
-- Ensure GROWTH_AGENT_EVAL (created by setup, owned by ACCOUNTADMIN) is accessible to CI.
GRANT USAGE ON DATASET PM_AGENTS_DEMO.APP.GROWTH_AGENT_EVAL TO ROLE PM_AGENTS_CI;
