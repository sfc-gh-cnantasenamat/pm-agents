...
AGENT_FQN="${AGENT_FQN:-DEVREL.CNANTASENAMAT_DEV.GROWTH_AGENT}"
DATASET_FQN="${DATASET_FQN:-DEVREL.CNANTASENAMAT_DEV.GROWTH_AGENT_EVAL}"
EVAL_STAGE="${EVAL_STAGE:-DEVREL.CNANTASENAMAT_DEV.EVAL_CONFIG_STAGE}"
